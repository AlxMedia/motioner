				...
				<div id="footer-bottom">
					...
					<div class="pad group">
						...
						<div class="grid one-full">
							...
							<div id="credit">
								<p><?php esc_html_e('Powered by','motioner'); ?> <a href="http://wordpress.org" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','motioner'); ?> <a href="https://agnarson.com" rel="nofollow">Alx</a>.</p>
							</div><!--/#credit-->
							<?php endif; ?>
